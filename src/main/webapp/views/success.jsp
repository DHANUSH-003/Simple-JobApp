...
<html>
<head>
    <title>Dhanush Job Portal</title>
    <link
...
<nav class="navbar navbar-expand-lg navbar-light bg-clr">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">Sample Job Portal</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="http://dhanusha-new-portfolio.netlify.app/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
